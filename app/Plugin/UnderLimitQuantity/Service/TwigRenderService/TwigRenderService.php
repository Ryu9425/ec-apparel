...
namespace Plugin\UnderLimitQuantity\Service\TwigRenderService;


use Eccube\Event\TemplateEvent;
use Plugin\UnderLimitQuantity\Service\TwigRenderService\builder\base\ContentBlockBuilderInterface;
use Plugin\UnderLimitQuantity\Service\TwigRenderService\builder\EachChildContentBlockBuilder;
use Plugin\UnderLimitQuantity\Service\TwigRenderService\builder\EachContentBlockBuilder;
use Plugin\UnderLimitQuantity\Service\TwigRenderService\builder\InsertContentBlockBuilder;
...
class TwigRenderService
{
     ...
     * @param array $params
     * @param bool $render
     * @return string|Twig_TemplateWrapper
