...
class CusSearchOrderItemType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('cus_shipping_date_start', DateType::class, [
                'label' => '出荷日(開始)',
                'required' => false,
                'input' => 'datetime',
                'widget' => 'single_text',
                ...
                'attr' => [
                    ...
                    // 'data-target' => '#'.$this->getBlockPrefix().'_cus_shipping_date_start',
                    // 'data-toggle' => 'datetimepicker',
                ],
            ])
            ->add('cus_shipping_date_end', DateType::class, [
                'label' => '出荷日(終了)',
                'required' => false,
                'input' => 'datetime',
                'widget' => 'single_text',
                ...
                'attr' => [
                    // 'class' => 'datetimepicker-input',
                    // 'data-target' => '#'.$this->getBlockPrefix().'_cus_shipping_date_end',
                    // 'data-toggle' => 'datetimepicker',
                ],
            ])
